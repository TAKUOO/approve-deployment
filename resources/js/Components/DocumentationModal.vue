<template>
    <Modal :show="show" @close="close" max-width="2xl">
        <div class="overflow-hidden relative bg-gradient-to-br from-slate-100 via-slate-200 to-indigo-200/50 text-slate-900">
            ...
            <div class="relative z-10 max-h-[80vh] overflow-y-auto">
                <div class="flex justify-end items-center p-4">
                    <button
                        @click="close"
                        class="p-2 text-gray-400 rounded-md transition-colors hover:text-gray-600 hover:bg-white/50"
                    >
                ...
                <div class="p-6">
                    <div class="px-4 mx-auto max-w-xl">
                        <div class="mb-8">
                            <h1 class="mb-2 text-3xl font-bold text-slate-900">ドキュメント</h1>
                                ...
                                <div class="max-w-none prose prose-slate">
                                    ...
                                    <div class="p-4 mb-4 rounded-lg bg-slate-50">
                                        ...
                                        <div class="relative group">
                                            <pre class="p-3 pr-12 text-sm rounded bg-slate-900 text-slate-100"><code>{{ sshKeyCommand }}</code></pre>
                                            <button
                                                @click="copyToClipboard(sshKeyCommand, 'ssh-key')"
                                                class="absolute top-2 right-2 p-2 rounded transition-colors text-slate-400 bg-slate-800 hover:text-slate-100 hover:bg-slate-700"
                                    ...
                                    <div class="p-4 mb-4 rounded-lg bg-slate-50">
                                        ...
                                        <div class="relative group">
                                            <pre class="p-3 pr-12 text-sm rounded bg-slate-900 text-slate-100"><code>{{ sshPubKeyCommand }}</code></pre>
                                            <button
                                ...
                                <div class="max-w-none prose prose-slate">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <button
                                            ...
                                            class="absolute top-4 right-4 p-2 rounded transition-colors text-slate-400 bg-slate-800 hover:text-slate-100 hover:bg-slate-700"
                            ...
                            <section id="deploy-path" class="p-8 bg-white rounded-2xl border shadow-sm border-slate-200">
                                ...
                                <div class="max-w-none prose prose-slate">
                                    ...
                                    <div class="p-4 mb-4 rounded-lg bg-slate-50">
                                        ...
                                        <div class="relative group">
                                            <pre class="p-3 pr-12 text-sm rounded bg-slate-900 text-slate-100"><code>{{ sshPathCommand }}</code></pre>
                                            <button
